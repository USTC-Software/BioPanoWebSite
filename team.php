...
<div class="main-content">
     ...
     <ul class="large-block-grid-6 medium-block-grid-4 small-block-grid-2 text-center">
         ...
         <li class ="profilewrap">
              ...
              <div class = "details"><img style="width:160px" src="http://2014.igem.org/wiki/images/e/ee/2014ustc-Zss.jpg" alt="Zhao Shensen"  align="left"><p>Work which make idea true make me happy.</p>
              </div>
         </li>
          <li class ="profilewrap">
              <img src="http://2014.igem.org/wiki/images/6/6e/2014ustc-Glz.jpg" alt="Haiyan Liu">
              <div class ="nameplate"><a href="#">Gan Longzhi</a></div>
              <div class = "details"><img style="width:160px" src="http://2014.igem.org/wiki/images/6/6e/2014ustc-Glz.jpg" alt="Haiyan Liu"  align="left"><p>Try hard, have fun.</p>
              </div>
         </li>
          <li class ="profilewrap">
          ...
          <li class ="profilewrap">
              ...
              <div class = "details"><img style="width:160px" src="http://2014.igem.org/wiki/images/1/1e/2014ustc-Wws.jpg" alt="Haiyan Liu"  align="left"><p>There is no fate but what we make.</p>
              </div>
         </li>
          <li class ="profilewrap">
              ...
              <div class = "details"><img style="width:160px" src="http://2014.igem.org/wiki/images/d/d0/2014ustc-Zzy.jpg" alt="Haiyan Liu"  align="left"><p>To see, to ask, to search, to believe.</p>
              </div>
         </li>
          ...
          <li class ="profilewrap">
              ...
              <div class = "details"><img style="width:160px" src="http://2014.igem.org/wiki/images/7/7d/2014ustc-Gyf.jpg" alt="Yifan Gao"  align="left"><p>Perfection is achieved not when there is nothing more to add, but rather when there is nothing more to take away.</p>
              </div>
         </li>
 		<li class ="profilewrap">
              ...
              <div class = "details"><img style="width:160px" src="http://2014.igem.org/wiki/images/4/4b/2014ustc-Dcx.jpg" alt="Haiyan Liu"  align="left"><p>All the time, try killing any idea from team.</p>
              </div>
        </li>
        ...
        <li class ="profilewrap">
              ...
              <div class = "details"><img style="width:160px" src="http://2014.igem.org/wiki/images/2/28/2014ustc-Jzy.jpg" alt="Haiyan Liu"  align="left"><p>Not most powerful, but highly responsible!</p>
              </div>
        </li>
        ...
        <li class ="profilewrap">
              ...
              <div class = "details"><img style="width:160px" src="http://2014.igem.org/wiki/images/9/97/2014ustc-Zl.jpg" alt="Haiyan Liu"  align="left"><p>Simply Enjoy.</p>
              </div>
        </li>
         ...
         <li class ="profilewrap">
              ...
              <div class = "details"><img style="width:160px" src="http://2014.igem.org/wiki/images/a/a1/2014ustc-Hlx.jpg" alt="Haiyan Liu"  align="left"><p>Where there is a will, there is a way.</p>
              </div>
        </li>
        ...
        <li class ="profilewrap">
              ...
              <div class = "details"><img style="width:160px" src="http://2014.igem.org/wiki/images/8/8d/2014ustc-Ycp.jpg" alt="Haiyan Liu"  align="left"><p>Do one thing at a time, and do well.</p>
              </div>
        </li>
        ...
        <li class ="profilewrap">
              ...
              <div class = "details"><img style="width:160px" src="http://2014.igem.org/wiki/images/4/44/2014ustc-Zhy.jpg" alt="Haiyan Liu"  align="left"><p>Be the best yourself, to be No.1. </p>
              </div>
        </li>
        ...
        <li class ="profilewrap">
              ...
              <div class = "details"><img style="width:160px" src="http://2014.igem.org/wiki/images/9/96/2014ustc-Fyc.jpg" alt="Haiyan Liu"  align="left"><p>Be the best yourself, to be No.1. </p>
              </div>
        </li>
        ...
        <li class ="profilewrap">
              ...
              <div class = "details"><img style="width:160px" src="http://2014.igem.org/wiki/images/b/bc/2014ustc-Ctl.jpg" alt="Haiyan Liu"  align="left"><p>Be the best yourself, to be No.1. </p>
              </div>
        </li>
        ...
        <li class ="profilewrap">
              ...
              <div class = "details"><img style="width:160px" src="http://2014.igem.org/wiki/images/e/e8/Clf.jpg" alt="Haiyan Liu"  align="left"><p>Be the best yourself, to be No.1. </p>
              </div>
        </li>
 ...
 <h4>Instructors & Advisors</h4>
    ...
    <ul class="large-block-grid-6 medium-block-grid-4 small-block-grid-2 text-center">
          <li class ="profilewrap">
              ...
              <div class = "details"><img style="width:160px" src="http://2014.igem.org/wiki/images/d/de/2014ustc-G.png" alt="Haiyan Liu" >
            ...
            <p><b>Brief Intro:</b>Haiyan Liu was born in Sichuan Province, China. He received his BS degree in Biology in 1990 and PhD degree in Biochemistry and Molecular Biology in 1996, both from USTC. Between 1993 and 1995 he was a visiting graduate student in Laboratory of Physical Chemistry of ETH, Zurich (Switzerland). From 1998 to 2000 he was post-doctoral research associate at Department of Chemistry, Duke University (USA) and Department of Biochemistry and Biophysics UNC-Chapel Hill (USA). Since 2001, he has been a professor of computational biology at School of Life Sciences, USTC.</p>
             ...
             <li class ="profilewrap">
              ...
              <div class = "details"><img style="width:160px" src="http://2014.igem.org/wiki/images/a/af/2014ustc-H.png" alt="Zhi Liang" >
           ...
           <li class ="profilewrap">
              ...
              <div class = "details"><img style="width:160px" src="http://2014.igem.org/wiki/images/9/93/2014ustc-I.png" alt="Jiong Hong" >
       ...
       <li class ="profilewrap">
              ...
              <div class = "details"><img style="width:160px" src="http://2014.igem.org/wiki/images/9/92/2014ustc-J.png" alt="Fan Jin" >
