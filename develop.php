...
<div class="main-content">
     <div class="row large-12 columns large-centered">
      ...
      <p></p>
      <p><b>Google API:</b><br />When the user inputs the keyword, it will be searched on Google. Then we parse the returned HTML, and save the title, author, abstract, and URL of the literature, which is convenient for the user.</p>
      <p></p>
